...
from surrogates.models import FNO
from surrogates.data.datasets import load_darcy_flow_small

from surrogates import Trainer, LpLoss, H1Loss
from surrogates.tests.test_utils import DummyDataset, DummyModel
from surrogates.training import IncrementalFNOTrainer, AdamW
